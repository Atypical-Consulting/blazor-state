                    ...
                    case PropertyType.ImmutableCollection:
                        {
                            ...
                            {
                                Line($"{property.Name} = _record.{property.Name}.ToList();");
                            }
                            else
                            {
                            ...
                            case PropertyType.ImmutableCollection:
                                {
                                    ...
                                    if (IsBuiltInType(itemType))
                                    {
                                        string convMethod = GetImmutableConversionMethod(property.Type);
                                        Line($"{property.Name} = this.{property.Name}.{convMethod},");
                                    }
                                    else
                                    {
