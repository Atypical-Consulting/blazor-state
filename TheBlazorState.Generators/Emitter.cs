...
internal static class Emitter
{
    public static string Emit(ComponentModel model)
    {
        ...
        sb.AppendLine("    private global::TheBlazorState.Services.StateManager __sm { get; set; } = null!;");
        sb.AppendLine();
        ...
        foreach (var field in model.Fields)
        {
            sb.AppendLine($"        public global::TheBlazorState.Builders.SliceBuilder<{field.FullTypeArgument}> {field.PropertyName} {{ get; }} = new global::TheBlazorState.Builders.SliceBuilder<{field.FullTypeArgument}>();");
        }
